...
I might even edit the script to basically replace kdesu entirely using polkit (Basically: kdesu calls polkit -> you get prompted to authenticate by polkit -> kdesu prompt arrives -> enter nothing -> App opens)
